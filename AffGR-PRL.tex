...
\begin{acknowledgments}
  ...
  %% Additionally, we thank the developers of the mathematical software \textsc{Sage}~\cite{sage} and \textsc{SageManifolds}~\cite{sagemanifolds,*Gourgoulhon:2014ywa}, used to achieve several manipulations.
