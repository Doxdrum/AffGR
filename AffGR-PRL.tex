...
A possibility of solving Eq.~\eqref{SimpleEOM} is considering Einstein spaces, since $R_{\mu\nu} \propto g_{\mu\nu}$. Therefore, every vacuum solution to the Einstein's equations solves the (torsionless) equation of motion of our affine model of gravity.
