...
\section{Explicit example: Schwarzschild ansatz, and (incomplete) Birkhoff theorem\label{Ex:sch}}
...
\begin{dmath}
  ...
  \label{eq4}
\end{dmath}
Equation~\eqref{eq1} can be rewritten as
\begin{equation}
...
Since
\begin{equation}
  \Delta_x e^{2\rho} = e^{2\rho} \bigg[ 4 \beta^{-2} + \frac{2}{\alpha \beta} \pa{\rho} \bigg( \frac{\alpha}{\beta} \bigg) \bigg] \equiv  e^{2\rho} \Big[ 4 \beta^{-2} + F \Big],
\end{equation}
it follows from Eq.~\eqref{eq3} that,
\begin{equation}
  mmmmmmmmm
\end{equation}
